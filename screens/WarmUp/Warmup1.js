...
const Warmup1 = () => {
  ...
  const title = 'Toe Taps';
  const description =
    'A great warm-up to improve foot coordination and agility. Toe-jumping exercises help activate your legs and prepare them for more intense movements.';

  const videoSource = require('../../assets/BoxingVideos/Warmup1.mp4');
