...
const Warmup3 = () => {
  ...
  const title = 'Mountain Climber';
  const description =
    'An intense full-body workout that builds strength, endurance, and agility, mimicking the climb to conquer your fitness goals';

  const videoSource = require('../../assets/BoxingVideos/Warmup3.mp4');
