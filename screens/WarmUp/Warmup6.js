...
const Warmup6 = () => {
  ...
  const title = 'Shadow Punching';
  const description =
    'Boost your strength and speed with this intense shadow punching workout';

  const videoSource = require('../../assets/BoxingVideos/Warmup6.mp4');
