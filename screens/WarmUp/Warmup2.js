...
const Warmup2 = () => {
  ...
  const title = 'Jumping Jacks';
  const description =
    'Get your energy soaring with this dynamic move to boost endurance and warm up your entire body';

  const videoSource = require('../../assets/BoxingVideos/Warmup2.mp4');
