...
const Warmup4 = () => {
  ...
  const title = 'Squats';
  const description =
    'Build lower body strength and stability with this foundational exercise, perfect for enhancing power and posture';

  const videoSource = require('../../assets/BoxingVideos/Warmup4.mp4');
