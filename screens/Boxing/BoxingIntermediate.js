...
const BoxingIntermediate = () => {
  ...
  const title = 'Cross Punch';
  const description =
    'The cross punch is a powerful, straight punch thrown with the rear hand, usually after a jab, aimed at overwhelming the opponent with speed and force';
const consequence = 'A strong jab can cause bruising, disorientation, or temporary vision loss.'
const speed='Speed: 9/10'
const power='Power: 8/10'
const Accuracy='Accuracy: 9/10'


  const videoSource = require('../../assets/BoxingExerciseVideos/Cross.mp4');
...
export default BoxingIntermediate;
