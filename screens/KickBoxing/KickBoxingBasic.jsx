...
const KickBoxingBasic = () => {
  ...
  const videoDetails = [
    {
      title: 'Front Kick',
      videoSource: require('../../assets/KickBoxing/basic1.mp4'),
    ...
    {
      title: 'Side Kick',
      videoSource: require('../../assets/KickBoxing/basic2.mp4'),
    ...
    },
    {
      ...
      videoSource: require('../../assets/KickBoxing/basic3.mp4'),
    ...
    {
      title: 'Axe Kick',
      videoSource: require('../../assets/KickBoxing/basic4.mp4'),
